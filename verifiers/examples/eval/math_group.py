...
rubric1 = vf.Rubric(funcs=[correct_answer_reward_func, parser.get_format_reward_func()], weights=[1.0, 0.2])
...
rubric2 = vf.Rubric(funcs=[incorrect_answer_reward_func, parser.get_format_reward_func()], weights=[1.0, 0.2])
