...
"""
inference:
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 vf-vllm --model willcb/Qwen3-1.7B --tensor-parallel-size 1 --data-parallel-size 6 --enforce-eager
...
size = '1.7B'
model_name = f'willcb/Qwen3-{size}'
