...
class ReasoningGymEnv(SingleTurnEnv):
    def __init__(
        ...
        **kwargs,
        ...
        self.rg_dataset = self.build_rg_dataset(
            gym, num_samples=total_samples, seed=seed
        )
    ...
    def build_rg_dataset(
        self, gym: str | List[str | dict], num_samples: int = 1000, seed: int = 0
    ) -> ProceduralDataset:
        ...
        return rg.create_dataset(
            "composite", datasets=dataset_specs, size=num_samples, seed=seed
        )
