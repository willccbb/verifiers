...
class CodeMathEnv(MultiTurnEnv):
    def __init__(self, system_prompt: str = CODE_PROMPT, max_turns: int = 5, **kwargs):
        ...
        super().__init__(system_prompt=system_prompt, parser=parser, rubric=rubric, max_turns=max_turns, **kwargs)
