...
from verifiers import ChatMessage, MultiTurnEnv, Rubric, State, XMLParser
...
class TextArenaEnv(MultiTurnEnv):
    ...
    def __init__(
        self, game: str = "Wordle-v0", num_samples: int = 1000, num_eval_samples: int = 100, seed: int = 0, **kwargs
    ):
        self.game = game
