...
# --- README embedding helpers (disabled) ---

# The previous logic that embedded reports into README files has been removed
# as part of simplifying the report generation flow. Reports continue to be
# generated under the environment's `reports/` directory, but README files are
# no longer modified automatically.
